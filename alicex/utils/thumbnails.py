...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("alicex/assets/font2.ttf", 30)
        font = ImageFont.truetype("alicex/assets/font.ttf", 30)
        title_font = ImageFont.truetype("alicex/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("alicex/assets/play_icons.png")
